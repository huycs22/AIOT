...
const DashboardfanPage = () => {
  ...
  const togglefan = async () => {
    ...
    if (isManualMode == 0) {
      setfanControlError("Chỉ có thể điều chỉnh quạt ở chế độ thủ công.");
      return;
    }
    ...
    <div className="flex flex-col min-h-screen">
      ...
      <div className="flex flex-grow">
        ...
        <div className="flex-1 p-6">
              ...
              <div className="w-48 p-4 bg-white border shadow rounded-lg flex items-center">
                ...
                <div>
                  ...
                  <p className="font-bold">
                    {currentfan !== null ? `${currentfan} °C` : "Đang tải..."}
                  </p>
                </div>
              </div>
            </div>
          ...
          {/* Điều chỉnh quạt */}
          <h2 className="text-xl font-bold mt-6 mb-2">Điều chỉnh quạt</h2>
          ...
          <h2 className="text-xl font-bold mt-6 mb-2">Lịch sử bật, tắt quạt</h2>
